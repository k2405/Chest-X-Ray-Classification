...
if __name__ == '__main__':
    ...
    study = optuna.create_study(direction='minimize', pruner=optuna.pruners.MedianPruner(), study_name='optuna_train_6', storage='sqlite:///ChestX.db', load_if_exists=True)
