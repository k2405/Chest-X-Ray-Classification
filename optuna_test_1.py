...
if __name__ == '__main__':
    ...
    def objective(trial):
        ...
        hidden_size_1 = trial.suggest_int('hidden_size1', 512, 2048)
        hidden_size_2 = trial.suggest_int('hidden_size2', 512, 2048)
