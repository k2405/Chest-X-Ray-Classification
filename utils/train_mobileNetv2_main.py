...
if __name__ == '__main__':
    ...
    set_params ={'lr': 0.00022911028228061618, 'batch_size': 46, 'grad_clip': 0.607530537953971, 'scheduler_name': 'CosineAnnealingLR', 'weight_decay': 2.1081075274879734e-07}
 ...
 #   transforms.Resize((224, 224)),
  ...
  #  transforms.RandomVerticalFlip(),
    ...
    for i in range(5):
        ...
        # Update the classifier for the desired output size (14 classes)
